...
def plan_trip():
    ...
    try:
        ...
        ai_analysis = generate_ai_analysis(origin, destination, traffic_data)
...
def generate_ai_analysis(origin, destination, traffic_data):
    ...
    if True :
        try:
            ...
            return simulate_ai_analysis(origin, destination, traffic_data)
    else:
...
def simulate_ai_analysis(origin, destination, traffic_data):
    ...
    for hour in optimal_hours:
        optimal_times_html += f"<li>{format_hour(hour['hour'])} - {hour['travel_time']} travel time</li>"
